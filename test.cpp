...
int Animation_base::update_animation(bool render_now, int animation_id)
{
  ...
  switch (animation_id)
  {
    ...
    for (int current_pixel = 0; current_pixel < this->get_pixel_range_end(); current_pixel+22)
    {
      ...
      {
        color =  Color(115, 0, 130);
      }
      for (size_t i = 0; i < 22; i++)
      {
        
        this->setPixelColor(current_pixel + i, color);
      }
